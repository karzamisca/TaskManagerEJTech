////views/sftpPages/sftpNorthernRepresentativeOffice/sftpNorthernRepresentativeOffice.js
// Global variables
let currentPath = "/northernRepresentativeOffice";
let selectedFiles = [];
let fileListData = [];
...
async function loadFileList(path) {
  ...
  if (!path.startsWith("/northernRepresentativeOffice")) {
    path = "/northernRepresentativeOffice" + (path === "/" ? "" : path);
  }
  ...
  try {
    ...
    if (path === "/northernRepresentativeOffice") {
...
function renderFileList(files) {
  ...
  if (currentPath !== "/") {
    ...
    parentRow.querySelector(".parent-dir").addEventListener("click", (e) => {
      ...
      if (
        parentPath.startsWith("/northernRepresentativeOffice") ||
        parentPath === "/northernRepresentativeOffice"
      ) {
